...
local text1 = redis:get(bot_id..'NightRang:new:sourse1')
local text2 = redis:get(bot_id..'NightRang:new:sourse2')
...
local Soundcloud = https.request('https://api-alshh.cf/snap.php?user='..Ttext)
local zxe = JSON.decode(Soundcloud)
