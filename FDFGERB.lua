...
local Status = redis:sismember(bot_id.."FDFGERB:Developer:Bot1", msg.sender_user_id_) 
...
Status = "البوت"
elseif redis:sismember(bot_id.."FDFGERB:Developer:Bot1", user_id) then
Status = redis:get(bot_id.."FDFGERB:Developer:Bot:Reply"..chat_id) or "Commander 🎖"  
elseif redis:sismember(bot_id.."FDFGERB:Developer:Bot", user_id) then
Status = redis:get(bot_id.."FDFGERB:Developer:Bot:Reply"..chat_id) or "Commander "  
elseif redis:sismember(bot_id.."FDFGERB:President:Group"..chat_id, user_id) then
...
local text1 = redis:get(bot_id..'FDFGERB:new:sourse1')
local text2 = redis:get(bot_id..'FDFGERB:new:sourse2')
text = text:gsub("━━━━━━━━",text1)
text = text:gsub("•",text2)
local TextParseMode = {ID = "TextParseModeMarkdown"}
...
if redis:get(bot_id.."FDFGERB:botsRedis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
send(msg.chat_id_,msg.id_, "\n• تم الغاء امر اضافة صلاحيه عامه") 
local CmdDel = redis:get(bot_id.."FDFGERB:botsAdd:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_)  
redis:del(bot_id.."FDFGERB:botsAdd:Validity:Group:Rt"..CmdDel..msg.chat_id_)
redis:srem(bot_id.."FDFGERB:botsValiditys:Group"..msg.chat_id_,CmdDel)  
redis:del(bot_id.."FDFGERB:botsRedis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
if not Constructor(msg) then
...
if text == "مدير" or text == "ادمن" or text == "مميز" or text == "عضو" then
local textn = redis:get(bot_id.."FDFGERB:botsAdd:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_)  
redis:set(bot_id.."FDFGERB:botsAdd:Validity:Group:Rt"..textn,text)
...
------------------------------------------------------------------------------------------------------------
if text and not redis:get(bot_id.."FDFGERB:Reply:Sudo"..msg.chat_id_) then
local anemi = redis:get(bot_id.."FDFGERB:Add:Rd:Sudo:Gif"..text)   
local veico = redis:get(bot_id.."FDFGERB:Add:Rd:Sudo:vico"..text)   
local stekr = redis:get(bot_id.."FDFGERB:Add:Rd:Sudo:stekr"..text)     
local Text = redis:get(bot_id.."FDFGERB:Add:Rd:Sudo:Text"..text)   
local photo = redis:get(bot_id.."FDFGERB:Add:Rd:Sudo:Photo"..text)
local video = redis:get(bot_id.."FDFGERB:Add:Rd:Sudo:Video"..text)
local document = redis:get(bot_id.."FDFGERB:Add:Rd:Sudo:File"..text)
local audio = redis:get(bot_id.."FDFGERB:Add:Rd:Sudo:Audio"..text)
if Text then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,data)
...
CmdStart = '\n• اهلا بك عزيزي \n انا بوت اسمي '..(redis:get(bot_id.."FDFGERB:Redis:Name:Bot") or "نايت رانج")..''..
...
redis:del(bot_id.."FDFGERB:botsAdd:Validity:Group:Rt"..ComdNew)
redis:srem(bot_id.."FDFGERB:botsValiditys:Group"..msg.chat_id_,ComdNew)  
...
redis:set(bot_id.."FDFGERB:botsAdd:Validity:Group:Rt:New"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
redis:sadd(bot_id.."FDFGERB:botsValiditys:Group"..msg.chat_id_,ComdNew)  
redis:setex(bot_id.."FDFGERB:botsRedis:Validity:Group"..msg.chat_id_..""..msg.sender_user_id_,200,true)  
...
local statusrt = redis:get(bot_id.."FDFGERB:botsAdd:Validity:Group:Rt"..mohammed) or redis:get(bot_id.."FDFGERB:Add:Validity:Group:Rt"..mohammed..msg.chat_id_)
...
redis:del(bot_id.."FDFGERB:Add:Validity:Users"..msg.chat_id_..result.sender_user_id_,mohammed) 
...
redis:set(bot_id.."FDFGERB:Add:Validity:Users"..msg.chat_id_..result.id_,mohammed)
...
redis:del(bot_id.."FDFGERB:Add:Validity:Users"..msg.chat_id_..result.id_,mohammed)
...
redis:sadd(bot_id.."FDFGERB:Silence:User:Groups", result.id_)
...
redis:srem(bot_id.."FDFGERB:Silence:User:Groups", result.id_)
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
end
...
if text and text:match("^انذار @(.*)$") and Admin(msg) and not redis:get(bot_id..'FDFGERB:inthar:group'..msg.chat_id_) then
function FunctionStatus(arg, result)
if (result.id_) then
local numinthar = tonumber(redis:get(bot_id.."FDFGERB:inthar"..msg.chat_id_..result.id_) or 0)
if numinthar == 0 then
redis:set(bot_id.."FDFGERB:inthar"..msg.chat_id_..result.id_,'1')
...
redis:set(bot_id.."FDFGERB:inthar"..msg.chat_id_..result.id_,'2')
elseif numinthar == 2 then
Send_Options(msg,result.id_,"reply","تم اعطائه انذار : 2 وتم كتمه")  
redis:del(bot_id.."FDFGERB:inthar"..msg.chat_id_..result.id_)
...
if text == ("انذار") and tonumber(msg.reply_to_message_id_) ~= 0 and Admin(msg) and not redis:get(bot_id..'FDFGERB:inthar:group'..msg.chat_id_) then
function FunctionStatus(arg, result)
local numinthar = tonumber(redis:get(bot_id.."FDFGERB:inthar"..msg.chat_id_..result.sender_user_id_) or 0)
if numinthar == 0 then
redis:set(bot_id.."FDFGERB:inthar"..msg.chat_id_..result.sender_user_id_,'1')
...
redis:set(bot_id.."FDFGERB:inthar"..msg.chat_id_..result.sender_user_id_,'2')
elseif numinthar == 2 then
Send_Options(msg,result.sender_user_id_,"reply","تم اعطائه انذار : 2 وتم كتمه")  
redis:del(bot_id.."FDFGERB:inthar"..msg.chat_id_..result.sender_user_id_)
redis:sadd(bot_id.."FDFGERB:Silence:User:Group"..msg.chat_id_, result.sender_user_id_)
end
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
...
redis:del(bot_id..'FDFGERB:inthar:group'..msg.chat_id_) 
Text = '\n تم تفعيل الانذارات' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل الانذار' and Admin(msg) then  
redis:set(bot_id..'FDFGERB:inthar:group'..msg.chat_id_,true) 
Text = '\nتم تعطيل الانذارات' 
send(msg.chat_id_, msg.id_,Text) 
end 
if text == 'تفعيل تحقق' and Admin(msg) then   
redis:del(bot_id..'FDFGERB:nwe:mem:group'..msg.chat_id_) 
Text = '\n تم تفعيل تحقق' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل تحقق' and Admin(msg) then  
redis:set(bot_id..'FDFGERB:nwe:mem:group'..msg.chat_id_,true) 
Text = '\nتم تعطيل تحقق' 
send(msg.chat_id_, msg.id_,Text) 
end 
...
redis:sadd(bot_id.."FDFGERB:Removalked:User:Groups", result.id_)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.id_)
...
redis:srem(bot_id.."FDFGERB:Removalked:User:Groups", result.id_)
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. result.id_ .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
else
send(msg.chat_id_, msg.id_,"المعرف غلط ")
end
...
redis:sadd(bot_id.."FDFGERB:Removalked:User:Groups", result.sender_user_id_)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
end
...
function FunctionStatus(arg, result)
redis:srem(bot_id.."FDFGERB:Removalked:User:Groups", result.sender_user_id_)
https.request("https://api.telegram.org/bot" .. token .. "/restrictChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" .. result.sender_user_id_ .. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
...
local list = redis:smembers(bot_id.."FDFGERB:Removalked:User:Groups")
if #list == 0 then
...
redis:sadd(bot_id.."FDFGERB:Developer:Bot1", result.id_)
...
redis:set(bot_id..'FDFGERB:new:sourse'..msg.chat_id_..msg.sender_user_id_,'true1') 
send2(msg.chat_id_, msg.id_, 'ارسل رمز بدلا عن هاذا \n ━━━━━━━━')
return false
end
if redis:get(bot_id..'FDFGERB:new:sourse'..msg.chat_id_..msg.sender_user_id_) == 'true1' then
redis:set(bot_id..'FDFGERB:new:sourse1',text)
send2(msg.chat_id_, msg.id_, 'الان ارسل رمز بدلا عن • ')
redis:set(bot_id..'FDFGERB:new:sourse'..msg.chat_id_..msg.sender_user_id_,'true2') 
return false
end
if redis:get(bot_id..'FDFGERB:new:sourse'..msg.chat_id_..msg.sender_user_id_) == 'true2' then
redis:set(bot_id..'FDFGERB:new:sourse2',text)
redis:del(bot_id..'FDFGERB:new:sourse'..msg.chat_id_..msg.sender_user_id_) 
send(msg.chat_id_, msg.id_, 'تم تغير شكل السورس')
return false
end
if text == 'حذف شكل السورس' and Dev_Bots(msg) then
redis:del(bot_id..'FDFGERB:new:sourse1')
redis:del(bot_id..'FDFGERB:new:sourse1')
send(msg.chat_id_, msg.id_, 'تم حذف تغير شكل السورس')
return false
end
if text == 'تفعيل @all' and Admin(msg) then   
redis:del(bot_id..'FDFGERB:tagall'..msg.chat_id_) 
Text = '\n اهلا عزيزي \n تم تفعيل امر @all' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل @all' and Admin(msg) then  
redis:set(bot_id..'FDFGERB:tagall'..msg.chat_id_,true) 
Text = '\nاهلا عزيزي \n تم تعطيل امر @all' 
send(msg.chat_id_, msg.id_,Text) 
end 
if text == ("@all") and Admin(msg) and not redis:get(bot_id..'FDFGERB:tagall'..msg.chat_id_) then
...
if text and text:match('@all (.*)') and Admin(msg) and not redis:get(bot_id..'FDFGERB:tagall'..msg.chat_id_) then
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa) 
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_
},function(ta,FDFGERB)
x = 0
...
local TextingDevStorm = redis:get(bot_id..'FDFGERB:Texting:DevSlbotss')
...
if text == 'وضع كليشه المطور' or text == 'ضع كليشه المطور' or text == 'ضع كليشة المطور' or text == 'ضع كليشه مطور' and Dev_Bots(msg) then
redis:set(bot_id..'FDFGERB:GetTexting:DevSlbotss'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'•  ارسل لي الكليشه الان')
return false 
end
...
redis:set(bot_id.."FDFGERB:id:user"..msg.chat_id_,yazon)  
...
redis:set(bot_id.."FDFGERB:idgem:user"..msg.chat_id_,yazon)  
...
redis:incrby(bot_id.."FDFGERB:Num:Add:Games"..msg.chat_id_..result.sender_user_id_,text:match("^اضف نقاط (%d+)$"))  
...
if text and text:match("^(.*)$") then
if redis:get(bot_id.."botss:FDFGERB:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\nارسل لي الكلمه الان ')
redis:set(bot_id.."botss:FDFGERB:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
redis:set(bot_id.."botss:FDFGERB:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
redis:sadd(bot_id.."botss:FDFGERB:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if redis:get(bot_id.."botss:FDFGERB:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"تم حذف الرد من ردود المتعدده")
redis:del(bot_id..'botss:FDFGERB:Add:Rd:Sudo:Text'..text)
redis:del(bot_id..'botss:FDFGERB:Add:Rd:Sudo:Text1'..text)
redis:del(bot_id..'botss:FDFGERB:Add:Rd:Sudo:Text2'..text)
redis:del(bot_id.."botss:FDFGERB:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
redis:srem(bot_id.."botss:FDFGERB:List:Rd:Sudo", text)
return false
end
end
if text == ("مسح الردود المتعدده") and Dev_Bots(msg) then 
local list = redis:smembers(bot_id.."botss:FDFGERB:List:Rd:Sudo")
for k,v in pairs(list) do  
redis:del(bot_id.."botss:FDFGERB:Add:Rd:Sudo:Text"..v) 
redis:del(bot_id.."botss:FDFGERB:Add:Rd:Sudo:Text1"..v) 
redis:del(bot_id.."botss:FDFGERB:Add:Rd:Sudo:Text2"..v)   
redis:del(bot_id.."botss:FDFGERB:List:Rd:Sudo")
end
...
redis:set(bot_id.."botss:FDFGERB:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الرد الذي اريد اضافته")
end
if text == "حذف رد متعدد" and DeveloperBot1(msg) then 
redis:set(bot_id.."botss:FDFGERB:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = redis:get(bot_id.."botss:FDFGERB:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if redis:get(bot_id.."botss:FDFGERB:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
redis:set(bot_id.."botss:FDFGERB:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
redis:set(bot_id.."botss:FDFGERB:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = redis:get(bot_id.."botss:FDFGERB:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if redis:get(bot_id.."botss:FDFGERB:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
redis:set(bot_id.."botss:FDFGERB:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
redis:set(bot_id.."botss:FDFGERB:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = redis:get(bot_id.."botss:FDFGERB:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if redis:get(bot_id.."botss:FDFGERB:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
redis:set(bot_id.."botss:FDFGERB:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
redis:set(bot_id.."botss:FDFGERB:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = redis:get(bot_id.."botss:FDFGERB:Add:Rd:Sudo:Text"..text)   
local Text1 = redis:get(bot_id.."botss:FDFGERB:Add:Rd:Sudo:Text1"..text)   
local Text2 = redis:get(bot_id.."botss:FDFGERB:Add:Rd:Sudo:Text2"..text)   
...
redis:set(bot_id..'FDFGERB:Num:Add:Bot',text:match("تعيين عدد الاعضاء (%d+)$") ) 
...
if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 or text == 'ID' and tonumber(msg.reply_to_message_id_) == 0 or text == 'Id' and tonumber(msg.reply_to_message_id_) == 0 or text == 'id' and tonumber(msg.reply_to_message_id_) == 0 and not redis:get(bot_id..'FDFGERB:Lock:Id:Photo'..msg.chat_id_) then
...
if text == 'dfgdgdfgdfgfdgfgdfgfdg' and Admin(msg) then   
redis:del(bot_id..'dw:bot:api'..msg.chat_id_) 
Text = '\n تم تفعيل التنزيلات' 
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'dfgdfgdfgdfgdfgdfgfdg' and Admin(msg) then  
...
if msg.content_.ID == "MessageChatJoinByLink" and not redis:get(bot_id..'FDFGERB:nwe:mem:group'..msg.chat_id_) then
...
if Text and Text:match('@id/(.*)') and redis:get(bot_id..'userusing:yt'..data.chat_id_..':'..data.sender_user_id_) == 'set' then
...
elseif Text and Text:match('mp3/(.*)') and redis:get(bot_id..'userusing:yt'..data.chat_id_..':'..data.sender_user_id_) == 'set' then
local Id_Link = Text:match('mp3/(.*)') 
Delete_Message(data.chat_id_,{[0] = Msg_id})    
https.request('https://api-alshh.cf/API/yt.php?url='..Id_Link..'&token='..token..'&chat='..data.chat_id_..'&type=mp3&msg=0')
redis:del(bot_id..'userusing:yt'..data.chat_id_..':'..data.sender_user_id_)
elseif Text and Text:match('mp4/(.*)') and redis:get(bot_id..'userusing:yt'..data.chat_id_..':'..data.sender_user_id_) == 'set' then
local Id_Link = Text:match('mp4/(.*)') 
Delete_Message(data.chat_id_,{[0] = Msg_id})    
https.request('https://api-alshh.cf/API/yt.php?url='..Id_Link..'&token='..token..'&chat='..data.chat_id_..'&type=mp4&msg=0')
redis:del(bot_id..'userusing:yt'..data.chat_id_..':'..data.sender_user_id_)
end
...
owner_id = admins[i].user_id_
redis:sadd(bot_id.."FDFGERB:President:Group"..Chat_id, owner_id)
end
end
end,nil)   
...
redis:set(bot_id.."FDFGERB:Lock:Sticker"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."FDFGERB:Lock:Animation"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."FDFGERB:Lock:Video"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."FDFGERB:Lock:Photo"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."FDFGERB:Lock:Audio"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."FDFGERB:Lock:vico"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."FDFGERB:Lock:forward"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."FDFGERB:Lock:Document"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."FDFGERB:Lock:Contact"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:set(bot_id.."FDFGERB:Lock:Spam"..Chat_id,'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
...
redis:hset(bot_id.."FDFGERB:Spam:Group:User"..Chat_id ,"Spam:User",'del')  
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'القائمة الرئيسيه', callback_data="/homelocks"},
